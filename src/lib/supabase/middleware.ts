...
export async function updateSession(request: NextRequest) {
  ...
  // If the route is /pengaturan, /produk and the role isn't admin, redirect them
  // We will handle role-based redirection later if needed, but for now middleware
  // ensures the user is at least authenticated. Keep it lightweight to save DB hits.
